...
!!! 選擇您的券商
    ...
    === "玉山證券"
        ...
        * 請先按照[config 教學](https://www.esunsec.com.tw/trading-platforms/api-trading/docs/trading/quick-start/)獲取 config 設定檔。
        * 並到登入[玉山證券API](https://www.esunsec.com.tw/trading-platforms/api-trading/docs/key/)，獲得市場行情 Token。
        ...
        假如使用中下單出現錯誤代碼，可以到[玉山證券文件](https://www.esunsec.com.tw/trading-platforms/api-trading/docs/trading/reference/error-code/) 來查找原因。假如對於 Finlab Package 下單不熟習，建議也可以先按照[券商的教學](https://www.esunsec.com.tw/trading-platforms/api-trading/docs/trading/quick-start/)來練習，假如串接成功，則 FinLab Package 的串接也就是如法炮製的設定囉！
